...
class Ciudadano extends Usuario {
    constructor(nombre, edad, username, contraseña, informesPresentados, ubicacionActual) {
...
class Admin extends Usuario {
    constructor(nombre, edad, username, contraseña, informesAsignados, roles, departamentos) {
        super(nombre, edad, username, contraseña);
