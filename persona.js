...
const personas = []; // Array para almacenar los datos de las personas
    ...
    rl.question('Ingrese su nombre: ', (nombre) => {
      ...
      rl.question('Ingrese su apellido: ', (apellido) => {
        ...
        rl.question('Ingrese su edad: ', (edad) => {
          ...
          personas.push({ nombre: this.nombre, apellido: this.apellido, edad: this.edad });
...
function mostrarTodasLasPersonas() {
  ...
  personas.forEach((persona, index) => {
    console.log(`${index + 1}: ${persona.nombre} ${persona.apellido}, ${persona.edad} años.`);
  });
}


class Usuario extends Persona {
    constructor(username, curp, correo, contraseña, telefono, direccion, notificaciones) {
